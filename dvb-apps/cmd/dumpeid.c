...
extern void
aribstr_to_utf8(uint8_t *src, size_t srclen, uint8_t *dest, size_t destlen);
...
struct evinfo {
	...
	uint8_t *title, *short_desc;
	unsigned int title_len, desc_len;
};
